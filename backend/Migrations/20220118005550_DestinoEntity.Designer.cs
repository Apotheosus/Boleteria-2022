...
namespace BoleteriaOnline.Web.Migrations
{
    ...
    [Migration("20220118005550_DestinoEntity")]
    partial class DestinoEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoleteriaOnline.Web.Data.Models.Arco", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("DestinoId")
                        .HasDatabaseName("ix_arista_destino_id");

                    b.HasIndex("OrigenId")
                        .HasDatabaseName("ix_arista_origen_id");

                    b.HasIndex("ViajeId")
                        .HasDatabaseName("ix_arista_viaje_id");
            ...
            modelBuilder.Entity("BoleteriaOnline.Web.Data.Models.Fila", b =>
                {
                    ...
                    b.Property<int?>("DistribucionId1")
                        .HasColumnType("int")
                        .HasColumnName("distribucion_id1");

                    b.Property<int?>("DistribucionId2")
                        .HasColumnType("int")
                        .HasColumnName("distribucion_id2");
                    ...
                    b.HasIndex("DistribucionId1")
                        .HasDatabaseName("ix_filas_distribucion_id1");

                    b.HasIndex("DistribucionId2")
                        .HasDatabaseName("ix_filas_distribucion_id2");
            ...
            modelBuilder.Entity("BoleteriaOnline.Web.Data.Models.Arco", b =>
                {
                    b.HasOne("BoleteriaOnline.Web.Data.Models.Destino", "Destino")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_arista_destinos_destino_id");
                    ...
                    b.HasOne("BoleteriaOnline.Web.Data.Models.Destino", "Origen")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_arista_destinos_origen_id");

                    b.HasOne("BoleteriaOnline.Web.Data.Models.Viaje", null)
                        .WithMany("Arcos")
                        .HasForeignKey("ViajeId")
                        .HasConstraintName("fk_arista_viajes_viaje_id");
            ...
            modelBuilder.Entity("BoleteriaOnline.Web.Data.Models.Fila", b =>
                {
                    ...
                    b.HasOne("BoleteriaOnline.Web.Data.Models.Distribucion", null)
                        .WithMany("PlantaAlta")
                        .HasForeignKey("DistribucionId1")
                        .HasConstraintName("fk_filas_distribuciones_distribucion_id1");

                    b.HasOne("BoleteriaOnline.Web.Data.Models.Distribucion", null)
                        .WithMany("PlantaBaja")
                        .HasForeignKey("DistribucionId2")
                        .HasConstraintName("fk_filas_distribuciones_distribucion_id2");
                });
            ...
            modelBuilder.Entity("BoleteriaOnline.Web.Data.Models.Distribucion", b =>
                {
                    ...
                    b.Navigation("PlantaAlta");

                    b.Navigation("PlantaBaja");
                });
