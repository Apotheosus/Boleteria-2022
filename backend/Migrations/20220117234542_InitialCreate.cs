        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    nota = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    distribucion_id1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    demora = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_arista", x => x.id);
                    table.ForeignKey(
                        name: "fk_arista_destinos_destino_id",
                        column: x => x.destino_id,
                        principalTable: "destinos",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_arista_destinos_origen_id",
                        column: x => x.origen_id,
                        principalTable: "destinos",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_arista_viajes_viaje_id",
                        column: x => x.viaje_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    recorrido_id = table.Column<int>(type: "int", nullable: false),
                    origen_id = table.Column<int>(type: "int", nullable: false),
                    destino_id = table.Column<int>(type: "int", nullable: false),
                    pasajero_id = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_arista_destino_id",
                table: "Arista",
                column: "destino_id");

            migrationBuilder.CreateIndex(
                name: "ix_arista_origen_id",
                table: "Arista",
                column: "origen_id");

            migrationBuilder.CreateIndex(
                name: "ix_arista_viaje_id",
                table: "Arista",
                column: "viaje_id");
